...
<head>
    ...
    <style>
        body { font-family: Arial; background-color:rgb(255, 255, 255); margin: 0; padding: 0; }
        ...
        .info { flex: 1; }
        .reserve-button, .cancel-button, .disabled-button, .invoice-button, .report-button, .comment-button {
            padding: 10px 10px;
            border: none;
            border-radius: 5px;
        ...
        .invoice-button { background-color:rgb(12, 222, 22); color: white; }
        .report-button { background-color: #ff7f00; color: white; }
        .comment-button { background-color: #17a2b8; color: white; }
        ...
        <?php foreach ($publications as $pub): ?>
            <div class="card">
                ...
                <div class="info">
                    ...
                    <a href="commentaire.php?id=<?= $pub['id'] ?>" class="comment-button">Ajouter un Commentaire</a>
                </div>
            </div>
        <?php endforeach; ?>
    <?php else: ?>
